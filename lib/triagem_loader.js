...
/* Normaliza para número: null/undefined/''/inválido viram NaN (não 0).
 * Necessário porque isNaN(null) === false faria um null escapar das
 * proteções de render e quebrar no .toFixed(). */
function num(x) {
